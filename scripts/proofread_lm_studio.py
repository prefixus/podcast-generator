...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Popraw błędy językowe w skrypcie podcastu przy użyciu lokalnego modelu w LM Studio."
    )
    parser.add_argument(
        "--input", default="output/Seksuologia_opracowane_tezy_script.json", help="Ścieżka do wejściowego pliku JSON"
    )
    parser.add_argument(
        "--output",
        default="output/Seksuologia_opracowane_tezy_script_proofread.json",
        help="Ścieżka do wyjściowego pliku JSON",
    )
